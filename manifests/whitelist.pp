...
class fail2ban::whitelist {
	...
	#узлы ЯДС
	'77.223.106.186',	#Облачный астериск селектел
	'176.96.80.135',	#Курганский офис
	'94.24.244.234',	#Челябинский офис
	'90.154.125.137',	#Москва - РТ
	'62.231.18.6',		#Москва - Билайн
	'212.55.98.9',		#Усинск - РТ
	'217.66.157.126',	#Усинск - Резерв
	'89.250.28.99',		#Красноярск
	...
	'91.109.230.34',	#Таймыр
	'91.109.230.30',	#Требса
	'91.109.227.6',		#Телепорт Наульское
	'91.109.230.54',	#Таналау
	'185.173.73.50',	#КТП-1 Паяха
	...
	'31.10.8.230',		#Рускай Сюрхорато
	'217.21.107.12',	#altegrosky NAT
	'188.19.169.151',	#Нефтеюганск
	'85.140.15.32',		#нефтеюганск второй участок
	'195.19.82.166',	#МСК - датацентр
	'188.75.10.142',	#МСК - офис на Вернадского
	'185.17.38.73',		#Телепорт? Куюмба
	'185.17.38.70',		#Телепорт КуюмбаЛевыйБерег
	'85.117.95.23',		#Дудинка
	'83.220.243.161',	#Баган
 	'193.150.103.74',	#msk-asterisk
        '217.21.107.237',	#Воронцово
	'217.21.107.244',	#Бухта Север
